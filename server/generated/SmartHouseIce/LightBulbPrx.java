...
public interface LightBulbPrx extends DevicePrx
{
    ...
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getBrightness", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
    ...
    default void setBrightness(int newBrightness)
        throws InvalidBrightnessException
    {
        setBrightness(newBrightness, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void setBrightness(int newBrightness, java.util.Map<String, String> context)
        throws InvalidBrightnessException
    {
        try
        {
            _iceI_setBrightnessAsync(newBrightness, context, true).waitForResponseOrUserEx();
        }
        catch(InvalidBrightnessException ex)
        {
            throw ex;
        }
    ...
    default java.util.concurrent.CompletableFuture<Void> setBrightnessAsync(int newBrightness)
    {
        return _iceI_setBrightnessAsync(newBrightness, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> setBrightnessAsync(int newBrightness, java.util.Map<String, String> context)
    {
        return _iceI_setBrightnessAsync(newBrightness, context, false);
    }

    /**
     * @hidden
     * @param iceP_newBrightness -
     * @param context -
     * @param sync -
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_setBrightnessAsync(int iceP_newBrightness, java.util.Map<String, String> context, boolean sync)
    {
        ...
        f.invoke(true, context, null, ostr -> {
                     ostr.writeInt(iceP_newBrightness);
                 }, null);
        return f;
    }
    ...
    {
        InvalidBrightnessException.class
    };
